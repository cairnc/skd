...
int main(int argc, char **argv) {
  ...
  for (int f = 0; f < 5; ++f) {
    ...
    AddLayer(*snap, 2, "Wallpaper#2", 0, 0, 1080, 2400, 0.12f, 0.2f, 0.35f, 1.f,
             1, 1);
    AddLayer(*snap, 3, "StatusBar#3", 0, 0, 1080, 90, 0.0f, 0.0f, 0.0f, 0.7f,
             200, 1);
    ...
    AddLayer(*snap, 5, "Dialog#5", 200 + dx, 900, 880 + dx, 1400, 0.25f, 0.55f,
             0.9f, 1.f, 150, 4);
  }
