...
sk_sp<SkShader>
StretchShaderFactory::createSkShader(const sk_sp<SkShader> &inputShader,
  ...
  float distanceStretchedX = StretchEffect::CONTENT_DISTANCE_STRETCHED /
                             (1 + abs(normOverScrollDistX));
  float distanceStretchedY = StretchEffect::CONTENT_DISTANCE_STRETCHED /
                             (1 + abs(normOverScrollDistY));
  float inverseDistanceStretchedX =
      1.f / StretchEffect::CONTENT_DISTANCE_STRETCHED;
  float inverseDistanceStretchedY =
      1.f / StretchEffect::CONTENT_DISTANCE_STRETCHED;
  float diffX = distanceStretchedX - StretchEffect::CONTENT_DISTANCE_STRETCHED;
  float diffY = distanceStretchedY - StretchEffect::CONTENT_DISTANCE_STRETCHED;
  ...
  mBuilder->uniform("uInterpolationStrength")
      .set(&INTERPOLATION_STRENGTH_VALUE, 1);
  mBuilder->uniform("uStretchAffectedDistX")
      .set(&StretchEffect::CONTENT_DISTANCE_STRETCHED, 1);
  mBuilder->uniform("uStretchAffectedDistY")
      .set(&StretchEffect::CONTENT_DISTANCE_STRETCHED, 1);
  ...
  mBuilder->uniform("uInverseDistanceStretchedX")
      .set(&inverseDistanceStretchedX, 1);
  mBuilder->uniform("uInverseDistanceStretchedY")
      .set(&inverseDistanceStretchedY, 1);
