...
// Drag these in: Hal.h is included by every SF source that needs CC_LIKELY
// and FlagManager. Centralising the transitive dependency here keeps the CE
// sources byte-identical with upstream. (HWC2.h can't live here — HWC2.h
// already includes Hal.h.)
