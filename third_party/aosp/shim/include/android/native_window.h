...
#define ANATIVEWINDOW_FRAME_RATE_CATEGORY_DEFAULT 0
#define ANATIVEWINDOW_FRAME_RATE_COMPATIBILITY_DEFAULT 0
#define ANATIVEWINDOW_FRAME_RATE_COMPATIBILITY_FIXED_SOURCE 1
#define ANATIVEWINDOW_FRAME_RATE_COMPATIBILITY_EXACT 100
#define ANATIVEWINDOW_CHANGE_FRAME_RATE_ONLY_IF_SEAMLESS 0
#define ANATIVEWINDOW_CHANGE_FRAME_RATE_ALWAYS 1
#define ANATIVEWINDOW_FRAME_RATE_SELECTION_STRATEGY_PROPAGATE 0
#define ANATIVEWINDOW_FRAME_RATE_SELECTION_STRATEGY_OVERRIDE_CHILDREN 1
#define ANATIVEWINDOW_FRAME_RATE_SELECTION_STRATEGY_SELF 2
