...
const Region Region::operator|(const Region &rhs) const { return merge(rhs); }
...
Region &Region::operator|=(const Region &rhs) { return orSelf(rhs); }
Region &Region::operator^=(const Region &rhs) { return xorSelf(rhs); }
Region &Region::operator&=(const Region &rhs) { return andSelf(rhs); }
Region &Region::operator-=(const Region &rhs) { return subtractSelf(rhs); }
