...
GaussianBlurFilter::GaussianBlurFilter()
    : BlurFilter(/* maxCrossFadeRadius= */ 0.0f) {}

sk_sp<SkImage> GaussianBlurFilter::generate(SkiaGpuContext *context,
  ...
  paint.setImageFilter(
      SkImageFilters::Blur(blurRadius * kInputScale * BLUR_SIGMA_SCALE,
