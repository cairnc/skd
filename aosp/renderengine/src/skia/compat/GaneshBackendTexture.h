...
public:
  // Creates an internal GrBackendTexture whose contents come from the provided
  // buffer.
  GaneshBackendTexture(sk_sp<GrDirectContext> grContext,
  ...
  sk_sp<SkSurface> makeSurface(ui::Dataspace dataspace,
...
private:
  ...
  void logFatalTexture(const char *msg, ui::Dataspace dataspace,
